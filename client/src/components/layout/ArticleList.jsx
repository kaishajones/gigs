                ...
                <div className="card">
                  <div className="card-body">
                    <div className="card-top-styles">
                      ...
                      <div className="card-action-buttons">
                        { showActionButton ? (
                          <>
                          <FontAwesomeIcon
                            onClick={(evt) => this.handleShowArticle(article.id, evt)}
                            style={{color: '#1DBC60', fontSize: '1.2rem'}} className="custom-card-link" icon={faEdit} />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <FontAwesomeIcon
                            onClick={(evt) => window.confirm("Are you sure you want to delete this article?") &&  this.handleDeleteArticle(article.id, evt)}
                            style={{color: '#ff0000', fontSize: '1.2rem'}} className="custom-card-link" icon={faTrash} />
                          </>
                        ) : null
                    ...
                    <p className="card-text">{article.content}</p>
                    {
                      ...
                      ): this.state.showComments[article.id] ? (
                        <span>
                        <hr />
                        <div className="text-right">
                          <a onClick={(evt) => this.handleHideComment(evt, article.id)} className="card-link custom-card-link">Hide comments</a>
                        </div>
                        <br />
